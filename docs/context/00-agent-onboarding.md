...
You are joining a **foundation-only** Search and Rescue (SAR) monorepo. Four people implement in parallel. Your job is to fill in **one seam** without inventing new data shapes or bypassing factories.
...
6. **Do not implement the full product in one PR.** This pass is foundation. See [06-out-of-scope.md](06-out-of-scope.md). Replace **your** stub; leave the others.
