...
const landingZones: LandingZone[] = [
  {
    ...
    approachBearingsDegrees: [0, 30, 180, 210, 330],
    assessedCriteria: ["slope", "footprint", "reachability", "canopy", "approach_clearance"],
    unassessedCriteria: [],
    notes:
  ...
  },
  {
    ...
    approachBearingsDegrees: [180, 210, 240],
    assessedCriteria: ["slope", "footprint", "reachability", "approach_clearance"],
    unassessedCriteria: ["canopy"],
    notes:
  ...
  },
  {
    ...
    approachBearingsDegrees: [270, 300],
    assessedCriteria: ["slope", "footprint", "reachability", "canopy", "approach_clearance"],
    unassessedCriteria: [],
    notes:
